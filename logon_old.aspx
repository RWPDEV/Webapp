<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="logon_old.aspx.vb" Inherits="WebApplication2.logon_old" %>
           ...
           <h3 class="text-center">INTEGRATED INFORMATION MANAGEMENT SYSTEM<br /><br /></h3>
                ...
                <form id="f1" runat="server">
                 ...
                 <div class="form-group  " style="align-content:center ;">
                  ...
                  <div class="form-group  " style="align-content:center ;">
                         <asp:Button CssClass="form-inline button button2" runat="server" ID="Buttongrp" type="submit"  style="width:200px ; border-radius:15px" Text="Enter"></asp:Button>
                    </div>
                     <asp:Label class="form-inline" runat="server" ID="lblapplication" Text="APPLICATION"></asp:Label><br />
                     <asp:DropDownList CssClass="form-inline" runat="server" ID="ddapplication" style="width:200px; height:35px; border-radius:35px"  DataTextField="application" DataValueField="application"></asp:DropDownList>
                     <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:misConnectionString %>" SelectCommand="select distinct application from menu_your_password_new where employee_code=@Ecode"></asp:SqlDataSource>--%>
                 
                    <div class="form-group" style="align-content:center ;">
                     <asp:Label class="form-inline" runat="server" ID="group" Text="GROUP"></asp:Label><br />
                     <asp:DropDownList CssClass="form-inline" runat="server" ID="ddgroup" style="width:200px; height:35px; border-radius:35px"  DataTextField="group_code" DataValueField="group_code"></asp:DropDownList>
